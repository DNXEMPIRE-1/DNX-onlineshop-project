...
mysqli_query($con,"insert into products (product_cat, product_brand,product_title,product_price, product_desc, product_image,product_keywords,qty,product_discount) values ('$product_type','$brand','$product_title','$price','$details','$pic_name','$tags','$qty','$discount')") or die ("query incorrect");
