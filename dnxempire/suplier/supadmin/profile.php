...
if (isset($_POST['re_password']))
  ...
  $password_query = mysqli_query($con,"select * from sup_info where email='$email'");
  ...
  if ($database_password == $old_pass)
    ...
    if ($new_pass == $re_pass)
      ...
      $update_pwd = mysqli_query($con,"UPDATE sup_info set password='$re_pass' where id='11'");
                      ...
                      <div class="col-md-5">
                        <div class="form-group bmd-form-group">
                          <label class="bmd-label-floating">
                            <?php  if (isset($_SESSION['email'])) : ?><?php echo $_SESSION['email']; ?>
             <?php endif ?>
